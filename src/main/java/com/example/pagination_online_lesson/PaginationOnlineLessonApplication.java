package com.example.pagination_online_lesson;

import com.example.pagination_online_lesson.dto.APIResponse;
import com.example.pagination_online_lesson.entity.Product;
import com.example.pagination_online_lesson.service.ProductService;
...
public class PaginationOnlineLessonApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(PaginationOnlineLessonApplication.class, args);
    }
